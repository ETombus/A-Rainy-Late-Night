...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        {
            InputBinding newBinding = action.bindings[bindingIndex]; //store the new binding for comparison

            foreach (InputBinding binding in action.actionMap.bindings) //check the new binding against all bidnings in the control scheme
            {
